  ...
  const handleSaveAddress = async (id) => {
    try {
      ...
      const requestBody = {
        ...
        district_id: selectedKabupaten || editedAddressData.district_id || "",
        sub_district_id:
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="hidden sm:inline">
        ...
        <div className="mb-5 ">
          <Button
            className="rounded-full w-1/3 h-11 hover:bg-white hover:text-black text-green-600 border border-[#3B8F51]"
            onClick={showModal}
          >
           + Tambah Alamat
          </Button>
      ...
      {/* Layar Hp */}
      <div className="sm:inline lg:hidden md:hidden sm:w-full w-full mx-auto  ">
        <div className="h-auto w-full mx-auto">
            ...
            {DataAlamatUser.map((alamat) => (
              ...
              >
                <div style={{ padding: "16px" }}>
                  ...
                  <div className="">
                    <div className="font-semibold mt-4">Tempat pengiriman</div>
                    <Select
                      value={alamat.address_as}
                      className="mt-4 border border-solid border-[#3B8F51] w-full rounded-lg h-[32px]"
                    >
                  ...
                  <div className=" mt-4">
                    <Button
                      onClick={() => handleSaveAddress(alamat.id)}
                      className="w-full rounded-full bg-[#3B8F51] h-10 px-5 text-white"
                    >
                      Simpan
                    </Button>
                  </div>
                  <div className=" mt-2">
                    <Button
                      onClick={() => handleDelete(alamat.id)}
                      className="w-full rounded-full h-10 hover:bg-white bg-white hover:text-black text-red-600 border-red-600"
                    >
                      Delete
                    </Button>
                  </div>
          ...
          <div>
            <Button
              className="rounded-full w-full h-11 hover:bg-white hover:text-black text-green-600 border border-[#3B8F51]"
              onClick={showModal}
            >
              + Tambah Alamat
            </Button>
